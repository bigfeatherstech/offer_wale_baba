        ...
        <>
            ...
            >
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-3xl md:text-4xl font-medium flex items-center gap-4 mt-20">
  <span className="w-1 h-12 bg-[#f7a221] rounded-full shadow-[0_0_20px_rgba(227,30,36,0.3)]"></span>
  Top Categories
</h3>

                    <button className="text-black mt-15  hover:text-secondary-hover transition-colors flex items-center  group text-sm uppercase tracking-widest">
                        Explore All <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                    </button>
                </div>
                <div className="grid grid-cols-4 md:grid-cols-5 gap-6 md:gap-10">
                    {categories.map((cat, idx) => (
                        ...
                        >
                            ...
                            <span className="text-[10px] md:text-xs  mt-5 group-hover:text-secondary text-center uppercase tracking-[0.15em] transition-colors leading-tight">
                                {cat.name}
                            </span>
                        </motion.div>
                    ))}
