                ...
                {indicators.map((item, idx) => (
                    ...
                    >
                        ...
                        <div className="space-y-1">
                            <h4 style={{fontSize:"16px"}}  className="font- text-white text-[12px] md:text-base uppercase ">
                                {item.title}
                            </h4>
                            <p style={{fontSize:"12px" , color:"#f7a221"}} className="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-tight">
                                {item.subtitle}
                            </p>
                        </div>
                    </div>
