...
import { selectWishlistCount } from '../REDUX_SEGMENT/wishlistSlice';
...
const Navbar = ({ searchQuery, setSearchQuery, isMenuOpen, setIsMenuOpen }) => {
    ...
    // Keep context as fallback (you can remove context entirely later)
    // const { items: contextWishlistItems } = useContext(WishlistContext);
    ...
    // Log for debugging
    useEffect(() => {
        console.log('🔄 Navbar - Redux wishlist count:', reduxWishlistCount);
        console.log('🔄 Navbar - Context wishlist count:');
    }, [reduxWishlistCount]);
    ...
    // Use Redux wishlist count for the badge (fallback to context if Redux count is 0 but context has items)
    const displayWishlistCount = reduxWishlistCount > 0 ? reduxWishlistCount : 0;
    ...
    const actionIcons = [
        ...
        { 
            ...
            badge: displayWishlistCount > 0 ? "bg-red-600" : "bg-gray-400", 
        ...
        { 
            ...
            label: "Cart", 
            count: cartCount, 
            badge: cartCount > 0 ? "bg-black" : "bg-gray-400", 
